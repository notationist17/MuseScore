...
MuseScore::MuseScore()
   : QMainWindow()
      ...
      transportTools = addToolBar(tr("Playback Controls"));
      ...
      fotoTools = addToolBar(tr("Image Capture"));
...
static bool doConvert(Score* cs, QString fn, QString plugin = "")
      ...
      if (fn.endsWith(".mscx")) {
            ...
            rv = mscore->saveSvgCollection(cs, fn, true, partsFileName, durationChecks);
            }
